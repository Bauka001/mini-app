export const SKIN_STYLES: Record<string, string> = {
  ...
  premium_gold: 'bg-amber-500/10 text-amber-200 border border-amber-400/40 shadow-[0_0_18px_rgba(245,158,11,0.28)] hover:bg-amber-500/20',
};

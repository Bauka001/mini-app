...
const Merge2048Game = () => {
  ...
  return (
    <GameWrapper
      title="Merge 2048"
      instructions={`🎯 МАҚСАТ: Сандарды біріктіріп 2048-ге жету.

📋 ЕРЕЖЕЛЕР:
1. Жоғарыда «Next: X» санын көресіз.
2. 6 бағанның БІРІН түртіңіз — сан төменге құлайды.
3. Бір бағанда бірдей сандар бір-біріне тиіссе — бірігеді (2+2=4, 4+4=8 ...).
4. 4096-ға жетсеңіз — 2 саны ойыннан алынады.
5. 8192-ге жетсеңіз — 4 саны алынады. (Деңгей өсу)
6. Тор толғанда ойын аяқталады.

💡 КЕҢЕС: Үлкен сандарды бір бұрышта жинап, кішілерді бөлек ұстаңыз. Хаос — жоғалу.`}
    >
      {({ onEnd, isPaused }) => {
